{products}
    <section id="p1-latest5" class="product-{index}">
        <div class="container">
            <div class="row {reverse}">
                ...
                <div class="col-md-6 {index}-bottom">
                    <div class="content-list-{index}-area">
                        <h5 class="list-{index}-top-title" >{pid}</h5>
                        <h2  class="{responsivefont}"> {build_name} </h2>
                        <h4> {cpu_brand} {cpu_name} {cpu_value} | {ram_value} {ssd_value} SSD | {gpu_name} {gpu_value}</h4>
