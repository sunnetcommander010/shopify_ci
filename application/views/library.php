                ...
                <div class="card">
                  ...
                  <div class="card-body text-center">
                      <h5 class="h2 card-title mb-4">
                        ...
                        echo '<a href="'.str_replace("index.php/", "", base_url()).'uploads/'.$file["directory"].'.pdf" target="_blank" style="color:white">
                        <button type="button" class="btn btn-success btn-view" name="'.$file["directory"].'" id="'.$key.'">
